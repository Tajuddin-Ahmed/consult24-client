    ...
    <>
          ...
          <div className="row">
            <div className="col-md-12 col-lg-12">
              <div className="border-bottom my-3">
                ...
                <address className="ps-4">408-470-3405</address>
              </div>
            </div>
          </div>
          <div className="row">
          ...
          <div className="row">
            <div className="col-md-12 col-lg-12">
              <div className="border-bottom my-3">
                ...
                <address className="ps-4">Albay,CA 94706</address>
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col-md-12 col-lg-12">
              <div className="border-bottom my-3">
                <div className="d-flex">
                  <BsFillTrophyFill />
                  <h6 className="ps-2">Year founded</h6>
                </div>
                <address className="ps-4">2018</address>
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col-md-12 col-lg-12">
              <div className="my-3">
                ...
                <address className="ps-4">2</address>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`col-md-6 col-lg-6 border py-2 ${cls.font}`}>
          ...
          <div className="bg-primary p-2 rounded">
            <p className="text-white">
              Tell customers what safety precautions you're taking for COVID-19
            </p>
          ...
          <div className="mx-3">
            ...
            >
              <div className="col-md-8 col-lg-8">
                <p>
                  Add a background check badge to your profile by authorizing a
                  free background check. This will help you build customer trust
                  and get hired more.
                </p>
              </div>
          ...
          <div className="d-flex justify-content-between p-2">
            <div>
              <p>
                ...
                <span className="fw-bolder small">Professional Licenses</span>
              </p>
            </div>
          </div>
          ...
          <div className="d-flex justify-content-between p-2">
            <div>
              <div>
                ...
                <p className="ms-2">
                  Customers will see this in search results, but it’s up to you
                  to work out final prices.
                </p>
      ...
      <div className="row justify-content-center my-3">
        <div className={`col-md-6 col-lg-6 border py-3 ${cls.font}`}>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-6">
              <div
                ...
                style={{ border: "2px dashed lightgray", height: "150px" }}
              >
          ...
          <div className="py-3 ">
            <button className="btn btn-info text-light">Add new project</button>
          </div>
        </div>
      </div>
      <div className="row justify-content-center my-3">
        <div className={`col-md-6 col-lg-6 border py-2 ${cls.font}`}>
          ...
          <div className="row">
            <div className="col-lg-5 col-md-5">
              <p style={{ margin: "0", padding: "0", color: "green" }}>0.0</p>
              <div>
                <AiOutlineStar />
                <AiOutlineStar />
                <AiOutlineStar />
            ...
            <div className="row p-3 border">
              ...
              <div className="col-lg-6 col-md-6">
                ...
                <p className="small lh-sm">
                  Tell us which customers to ask for a review, and we'll send
                  the request for you.
                </p>
              </div>
              <div className="col-lg-4 col-md-4 d-flex align-items-center">
                <button className="btn btn-info btn-sm">Ask for Reviews</button>
              </div>
            </div>
          </div>
        </div>
