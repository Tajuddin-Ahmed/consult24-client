...
interface ListingAreaTwoProps {
  titleOne?:boolean;
  titleTwo?:boolean;
  bgColor?:string;
  paddingBottom70?:string;
  ListingButton?:boolean;
}

const ListingAreaTwo:React.FC<ListingAreaTwoProps> = ({ titleOne, titleTwo, bgColor,paddingBottom70, ListingButton }) => {
